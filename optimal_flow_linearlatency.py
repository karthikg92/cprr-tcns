...
def optimal_flow_linearlatency(network, users):
    ...
    for e in range(num_edges):
        for u in range(num_users):
            obj += users.data[u]['vot'] * network.edge_latency[e] * x_eu[e, u]
            obj += users.data[u]['vot'] * x_eu[e,u] * x_e[e] * network.latency_slope[e]
    m.setObjective(obj)
