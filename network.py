...
class Network:
    ...
    def __init__(self, city):
        ...
        self.latency_slope = self._compute_latency_slope()
    ...
    def _compute_latency_slope(self):
        latency_slope_array = self.raw_edges['slope'].to_list()
        return latency_slope_array
